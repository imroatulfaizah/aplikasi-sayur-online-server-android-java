...
import com.faizah.sayonserver.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void showDialog() {
        ...
        txtcategory = add_menu_layout.findViewById(R.id.txtcategory);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            imageFolder.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    newCategory = new Category(txtcategory.getText().toString(),uri.toString());
                                }
                            });
                        }
                    })
    ...
    private void loadMenu() {
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //mengirim data category id dan masuk ke menu foodlist
        ...
        adapter.notifyDataSetChanged(); //untuk refresh data jika datanya berubah
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_order) {
           ...
           startActivity(orders);
            ...
            Intent order = new Intent(Home.this,OrderTerkirim.class);
            startActivity(order);
    ...
    private void showUpdateDialog(final String key, final Category item) {
        ...
        alertDialog.setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                item.setName(txtcategory.getText().toString());
